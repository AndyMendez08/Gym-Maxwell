  ...
  return (
    <section id="contacto" className="bg-neutral-900 border-t border-b border-neutral-800">
      <div className="py-24 max-w-7xl mx-auto px-6">
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both bg-neutral-950 border border-neutral-800 rounded-3xl p-8 md:p-12 lg:p-16 flex flex-col md:flex-row items-center justify-between gap-12">
      ...
      <div className="relative py-32 overflow-hidden bg-neutral-950">
        ...
        <div className="animate-in fade-in zoom-in-95 duration-1000 fill-mode-both relative z-10 max-w-4xl mx-auto px-6 text-center">
